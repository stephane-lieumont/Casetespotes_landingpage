  ...
  <?php require './layout/header.php'; ?>
    ...
    <main class="col-12 mb-5 row">
        <section class="col-lg-7 col-md-12">
          <h2>Evenement du 10 Novembre 2021</h2>
          <p> 
          ...
          <p>
            A l'issue de ces 2 speed-datings, les "Caseurs" / "Caseuses" votent pour les célibataires qui pourraient correspondre à leur meilleur·e ami·e et les célibataires votent pour ceux avec qui ça a fait tilt pendant leur échange.
          </p>
          <p>
            Case Ton Pote compare ensuite les résultats des votes de part et d'autre et vérifie s'il y a "match" pour certains célibataires. Et comme on aime gâter notre communauté, Case Ton Pote réserve une surprise aux célibataires 
            pour lesquels il y aura eu "match" ! Cerise sur le gâteau, notre évènement est gratuit et on vous offre un verre &#128521;
          </p>
