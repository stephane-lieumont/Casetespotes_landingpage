        ...
        <section id="homepage__content">
          <div id="homepage__bubble">
            <aside className="bubble">
              <h2 className="bubble__content">
                Application gratuite pendant 6 mois pour toute préinscription
              </h2>
            </aside>
          </div>
              ...
              childHeader={
                <Fragment>
                  ...
                  <p id="homepage__intro" className="reveal-3">
                    Découvrez bientôt en version Bêta-Test notre nouvelle application de rencontre
                    mettant l&apos;amitié au coeur de l&apos;amour pour faciliter les rencontres et
                    accompagner les célibataires.
                  </p>
                </Fragment>
              }
              className="reveal-5"
                ...
                <Fragment>
                  <div id="homepage__footer" className="reveal-6">
                    <p className="text--caption">
                      Les informations recueillies sur ce formulaire sont enregistrées par Case Tes
                      Potes pour permettre de vous adresser des contenus adaptés à votre profil.
                      Elles sont destinées au service Marketing. Conformément à la loi
                      &quot;Informatique et Liberté&quot;, vous pouvez exercer votre droit
                      d&apos;accès aux données vous concernant et les faire rectifier en écrivant à{" "}
