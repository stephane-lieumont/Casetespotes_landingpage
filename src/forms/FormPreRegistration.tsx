...
const FormPreRegistration: FunctionComponent<FormComponent> = ({
  childHeader = null,
  childFooter = null,
  className = "",
  submitIsValid = false,
      ...
      <form className="form">
        ...
        <div className="form__row">
          ...
          <Input
            ...
            onChange={(inputValue: string) =>
              setFormInputPhone({ ...formInputPhone, value: inputValue, error: false })
            }
            disabled={formDisabled}
          />
        </div>
        <SelectBox
          ...
          onChange={(inputValue: string) =>
            setFormInputChoice({ ...formInputChoice, value: inputValue, error: false })
          }
          disabled={formDisabled}
        />
        <Checkbox
