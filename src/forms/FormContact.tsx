...
const FormContact: FunctionComponent<FormComponent> = ({
  childFooter = null,
  submitIsValid = false,
  ...
  const validForm = (): boolean => {
    ...
    return checkLastname || checkFirstname || checkEmail || checkSubject || checkMessage
      ? false
      : true;
  };
    ...
    <div className="wrapper-form">
      <form className="form form--light">
        <div className="form__row">
          <Input
            ...
            onChange={(inputValue: string) =>
              setFormInputLastname({ ...formInputLastname, value: inputValue, error: false })
            }
            disabled={formDisabled}
          />
          <Input
            ...
            onChange={(inputValue: string) =>
              setFormInputFirstname({ ...formInputFirstname, value: inputValue, error: false })
            }
            disabled={formDisabled}
          />
        </div>
        <Input
          ...
          onChange={(inputValue: string) =>
            setFormInputEmail({ ...formInputEmail, value: inputValue, error: false })
          }
          disabled={formDisabled}
        />
        <Input
          ...
          onChange={(inputValue: string) =>
            setFormInputSubject({ ...formInputSubject, value: inputValue, error: false })
          }
          disabled={formDisabled}
        />
        <TextArea
          ...
          onChange={(inputValue: string) =>
            setFormInputMessage({ ...formInputMessage, value: inputValue, error: false })
          }
          disabled={formDisabled}
        />
        <div className="form__row">
